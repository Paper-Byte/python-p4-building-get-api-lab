...
Revision ID: b611907cfc73
Revises: a50cde241c4b
Create Date: 2023-10-13 09:07:03.903239
...
def upgrade():
    ...
    with op.batch_alter_table('baked_goods', schema=None) as batch_op:
        ...
        batch_op.create_foreign_key(batch_op.f(
            'fk_baked_goods_bakery_id_bakeries'), 'bakeries', ['bakery_id'], ['id'])
...
def downgrade():
    ...
    with op.batch_alter_table('baked_goods', schema=None) as batch_op:
        batch_op.drop_constraint(batch_op.f(
            'fk_baked_goods_bakery_id_bakeries'), type_='foreignkey')
